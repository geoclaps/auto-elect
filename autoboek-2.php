						...
						<div class="autoboek">
							<div class="col-md-12">
								<ul class="progress">
									...
									<li class="active"><a href="#autoboek">2. Model</a></li>
							...
							<?php
								for ( $i=0; $i<27; $i++ ){
									...
									<div class="col-md-2 col-sm-3 col-xs-6">
										<a href="autoboek-3.php#autoboek" class="brand-holder">
											<img src="<?= $root_url; ?>assets/img/brand-alfa-julietta.png" alt="" />
											<div class="add-txt">Alfa Romeo Julietta</div>
										</a>
									</div>
									<?php
								}
